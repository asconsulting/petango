...
class Config extends Contao_Backend
{
	...
	public function generateAlias($varValue, \DataContainer $dc)
	{
		...
		$objAlias = Database::getInstance()->prepare("SELECT id FROM tl_petango_config WHERE id=? OR alias=?")
	...
	{
		$objVersions = new \Versions('tl_petango_config', $intId);
		$objVersions->initialize();

		// Trigger the save_callback
		if (is_array($GLOBALS['TL_DCA']['tl_petango_config']['fields']['published']['save_callback']))
		{
			foreach ($GLOBALS['TL_DCA']['tl_petango_config']['fields']['published']['save_callback'] as $callback)
			{
