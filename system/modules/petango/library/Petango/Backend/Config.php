...
class Config extends Contao_Backend
{
	...
	public function toggleVisibility($intId, $blnVisible, \DataContainer $dc=null)
	{
		...
		if (is_array($GLOBALS['TL_DCA']['tl_petango_config']['fields']['active']['save_callback']))
		{
			foreach ($GLOBALS['TL_DCA']['tl_petango_config']['fields']['active']['save_callback'] as $callback)
			{
